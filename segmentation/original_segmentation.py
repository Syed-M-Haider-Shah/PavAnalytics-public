...
SOURCE_IMAGES_DIR = r"D:\distributed_data_70_15_15-new\train\1"
OUTPUT_SEGMENTS_DIR = r"D:\distributed_data_70_15_15-new\train\segment Images"
CHECKPOINT_DIR    = r"D:/checkpoints/final_model"
IMG_SIZE    = 512
...
model.to(DEVICE)
model.eval()
image_paths = sorted(glob(os.path.join(SOURCE_IMAGES_DIR, "*.jpg")))
...
for img_path in tqdm(image_paths, desc="Segmenting images"):
    ...
    seg_img.save(os.path.join(OUTPUT_SEGMENTS_DIR, fname))
